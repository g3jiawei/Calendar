...
public class AddAssignmentActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		assignment = (Assignment) intent.getSerializableExtra("assignmentKey");
	...
	public void saveNewAssignment(View view) {
		...
		EditText editDate = (EditText)
				findViewById(R.id.et_date_assignment);
		EditText editTime = (EditText)
				findViewById(R.id.et_time);
		
		String title = editCode.getText().toString().toLowerCase();
		String date = editDate.getText().toString().toLowerCase();
		String time = editTime.getText().toString().toLowerCase();
